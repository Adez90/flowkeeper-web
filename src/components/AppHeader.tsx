...
export function AppHeader({ me, activeAccountRole, activeAccountType }: AppHeaderProps) {
	...
	return (
		<header className="app-header">
			...
			<div className={`app-header__menu${menuOpen ? " app-header__menu--open" : ""}`}>
				<nav className="app-header__nav" onClick={() => setMenuOpen(false)}>
					...
					<NavLink to="/app/integrations" className={({ isActive }) => (isActive ? "active" : undefined)}>
						{t("nav.integrations")}
					</NavLink>
